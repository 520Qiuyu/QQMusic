...
(function (antd, require$$1, require$$2, icons) {
  ...
  const msgLoading = (loadingContent, completeCallBack, successContent = "操作成功", errorContent = "操作失败") => {
    message.loading(loadingContent, 0).then(() => {
    }).then(
      () => {
  ...
  */
  ...
  const HotSongModal = require$$1.forwardRef((props, ref) => {
    ...
    const [downloading, setDownloading] = require$$1.useState(false);
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(antd.Space, { size: "middle", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              antd.Button,
              {
                type: "link",
                size: "small",
                icon: downloading ? /* @__PURE__ */ jsxRuntimeExports.jsx(icons.LoadingOutlined, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(icons.DownloadOutlined, {}),
                onClick: () => {
    ...
    const renderFooter = () => {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2["footer"], children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(antd.Button, { type: "primary", onClick: () => {
        }, children: "下载全部" })
      ] });
    };
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
  ...
  const AlbumListModal = require$$1.forwardRef((props, ref) => {
    ...
    const { modal: ModalUtils2 } = antd.App.useApp();
    const [searchParams, setSearchParams] = require$$1.useState({
      pageNum: 1,
      pageSize: 20
    });
    ...
    const handlePlay = async (record) => {
      try {
        ...
        antd.message.destroy();
        antd.message.error("播放失败: " + error.message);
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(antd.Space, { size: "middle", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              antd.Button,
              {
                type: "link",
                size: "small",
                icon: isPlaying === record.albumMid ? /* @__PURE__ */ jsxRuntimeExports.jsx(icons.PauseCircleOutlined, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(icons.PlayCircleOutlined, {}),
                onClick: () => {
